...
sudo -u hdfs hdfs dfs -mkdir -p /user/{{pillar.cdh4.hive.user}}/warehouse
sudo -u hdfs hdfs dfs -chmod a+rwx /user/{{pillar.cdh4.hive.user}}/warehouse
sudo -u hdfs hdfs dfs -chmod a+rwx /tmp
